    ...
    <div style={{ minHeight: "100dvh", background: C.cream, fontFamily: FONT_BODY, color: C.espresso }}>
      ...
      >
        ...
        {(() => {
          ...
          // Brand glyphs use the official single-path logos (filled,
          // currentColor) so Instagram + TikTok read as the real marks.
          const brandSvgProps = { width: 19, height: 19, viewBox: "0 0 24 24", fill: "currentColor" };
          const socialIcon = (key: string) => {
            if (key === "ig") return (
              <svg {...brandSvgProps} aria-hidden>
